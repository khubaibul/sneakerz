    ...
    return (
        <div className="navbar border-b-2 lg:h-24 p-0">
            <div className="navbar-start flex justify-between w-full">
                ...
                <Link className="btn btn-ghost lowercase lg:hidden font-bold text-3xl" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>sneakerz</Link>
                <div className='flex items-center lg:gap-x-8 gap-x-12 lg:hidden'>
